...
class PDFToc
  ...
  def new_toc
    ...
    new_toc = PDFToc.new(new_toc_hash)
  end
...
if __FILE__==$0
  ...
  t = PDFToc.new(content: IO.readlines('simple.pdf.txt'), label: 'ROOT')
  t.parse
  pp t

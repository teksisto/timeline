- [Предпосылки](#orgcbdd0dc)
- [Задачи инфоорга](#org3409f4d)
  - [Захват](#org5b4243d)
  - [Идентификация](#org334c857)
  - [Хранение](#orgc483f3d)
  - [Классификация](#org121972a)
  - [Структурирование](#org5d94b21)
  - [Поиск](#orge671d6d)
  - [Репрезентация](#org2fe7201)
  - [Аннотирование](#org35d7911)
  - [Переносимость](#org31c47cf)
- [Чего мне хочется от информационного менеджера](#orge6ad6ca)
  - [Объединение базы данных и файлового менеджера](#org14e4062)
  - [Блочный текстовый редактор](#orgef6d460)
    - [Зачем бить на блочные элементы](#orgdc8da09)
  - [Динамические деревья](#org4cff6cf)
    - [Проблемы иерархических файловых систем](#org6c96ff2)
    - [Замена одного дерево на множество](#orgd5fd435)
    - [Сохранение файловой семантики](#org599cfe1)
  - [Контекст](#orgf57886d)
    - [Заголовочный блок](#org6fd9f3e)
    - [Форма быстрого поста](#org4557512)
    - [Хвост](#org54cf6b6)
    - [Контекст есть у каждого ресурса](#orgaefbcb1)
    - [Контекст как строительный блок интерфейса](#org24d3a5c)
    - [Динамическое дерево как вложенные контексты](#org603f905)
  - [Параллельные тексты](#org5970b9e)
- [Что бы я со всем этим делал](#org652c391)
  - [Оглавления для источников](#org7c6dfb6)
  - [Конспекты](#org5ab17f1)
  - [Цитатник](#org0d495f1)
    - [Привязка цитат к оглавлению книги](#org9916f03)
    - [Заголовки для цитат](#org0e1dea3)
    - [Форматирование внутри цитат](#org68418e2)
    - [Параллельные цитатники](#org2dd7102)
    - [Колоды](#orga190896)
    - [Рифмы](#org94baa40)
    - [Компартментализм](#org5011c00)
  - [События](#org9e57577)
  - [Словарь](#org013ba32)
    - [Личный словарь терминов](#orgc3485e1)
    - [Словарь иностранных слов](#orgc6e10cf)
  - [Импорт данных из веб-сервисов](#orgd9023c6)
- [Поиск подхода к реализации](#org5bb6492)
  - [Декомпозиция](#orgbfd4a46)
    - [Блог](#org0bba7ac)
    - [Оценка количества триплетов при импорте книги](#orgeba094b)
  - [Базовые определения](#org0af1282)
    - [Ресурс](#org74061d1)
    - [Представление](#org0e2f3b6)
    - [Атрибут](#org6302f4a)
    - [Адаптер](#org5f3efe8)
- [Как это все может выглядеть на практике](#orge9ce05f)
  - [Реляционный подход](#org9338c7d)
    - [Конспект](#orgf9175c9)
    - [Цитаты, разложенные по главам](#org28b032b)
  - [Обычный реляционный подход + наведенная семантика](#org2aaf13f)
  - [Семантика](#org7bb68a8)
    - [OpenLink Virtuoso](#org5427814)
    - [Stardog](#orgaf7f523)
    - [AllegroGraph](#org5897c43)
  - [Графовая база данных](#org111c12c)
- [История](#org35576f8)
  - [(1945) Vannevar Bush — As We May Think](#org69054f6)
  - [(1967) Andries van Dam, Ted Nelson — Hypertext Editing System](#org62c5d81)
  - [(1968) Douglas Engelbart — oN-Line System](#orgff3de17)
  - [(1968) Andries van Dam — File Retrieval and Editing System](#org9171dae)
  - [(1985) Intermedia](#orgb829f50)
  - [(1991) Gifford — Semantic file systems](#org37aac62)
  - [(1993) LDAP](#orgb8189f3)
  - [(1996) Eric Freeman and David Gelertner — Lifestreams](#orgc9aaeac)
  - [(1999) Presto](#orgcde7516)
  - [(2000) id3v2.4](#orgf96d83a)
  - [(2000) MusicBrainz](#orgfd3280c)
  - [(2001) Eric Kim — Purple](#org9e4a3fc)
  - [(2001) Tim Berners-Lee — Semantic Web](#org63546b8)
  - [(2001) Tinderbox](#org3d2db4f)
  - [(2003) Joshua Schachter — Del.icio.us](#org576b906)
  - [(2003) Carsten Dominik — Org-mode](#org516e142)
  - [2006 Calibre](#orga6fca44)
  - [(2004) W3C — RDF / RDFS / OWL](#org382e79c)
  - [(2007) DBpedia](#org7ee202d)
  - [(2007) Scrivener](#org027c567)
  - [(2008) Evernote](#org0cf4fee)
  - [(2009) Fluidinfo](#orge7615cb)
  - [(2013) Ginko](#org4088c07)
  - [Smallest Federated Wiki](#org6f75071)
  - [Chandler](#orgcfb39d7)
  - [CommonTag](#org62e363d)
  - [Friendfeed](#orge829520)
  - [Locker](#orgbbb876d)
  - [Singly](#org2f853cf)
  - [NEPOMUK](#org32fcf1c)
  - [TiddlyWiki](#org5b1b58f)
- [Ссылки](#orgd7e676b)
  - [Учебные заведения](#org52fe110)
  - [Термины](#orgb29ac7c)
  - [Люди](#org546f603)
  - [Книги](#org96914a9)
  - [Ассоциации](#orge208ad0)
  - [urbansheep](#org7069171)
    - [Pinboard](#orgb4e8f9f)
    - [FriendFeed](#org07d4c8a)
    - [LiveJournal](#org1c65de2)
  - [Конференции](#org4502b24)

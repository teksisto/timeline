- [Предпосылки](#org7a48ef1)
- [Задачи инфоорга](#org5aeb898)
  - [Захват](#org3b29a15)
  - [Идентификация](#orgfa4cf0f)
  - [Хранение](#org0c4adb1)
  - [Классификация](#org0cdfd96)
  - [Структурирование](#org51db38b)
  - [Поиск](#org08c0253)
  - [Репрезентация](#org2f48afa)
  - [Аннотирование](#orga47f729)
  - [Переносимость](#orgd621654)
- [Чего мне хочется от информационного менеджера](#org0600581)
  - [Объединение базы данных и файлового менеджера](#org56034dc)
  - [Блочный текстовый редактор](#orga71f46e)
    - [Зачем бить на блочные элементы](#org8a37582)
  - [Динамические деревья](#org74aaae1)
    - [Проблемы иерархических файловых систем](#orgd547c8f)
    - [Замена одного дерево на множество](#org0c427fa)
    - [Сохранение файловой семантики](#org8619ecf)
  - [Контекст](#orgd801999)
    - [Заголовочный блок](#orgaefaad6)
    - [Форма быстрого поста](#org375f316)
    - [Хвост](#org7ba9aa6)
    - [Контекст есть у каждого ресурса](#orgdaef677)
    - [Контекст как строительный блок интерфейса](#org18d4f16)
    - [Динамическое дерево как вложенные контексты](#org4e9df02)
  - [Параллельные тексты](#org54c5ff4)
- [Что бы я со всем этим делал](#org1dee4b7)
  - [Оглавления для источников](#orga0bc9c4)
  - [Конспекты](#org8f40eb0)
  - [Цитатник](#org428dbdf)
    - [Привязка цитат к оглавлению книги](#org6fb5d71)
    - [Заголовки для цитат](#org075c030)
    - [Форматирование внутри цитат](#orga11d3df)
    - [Параллельные цитатники](#orge6429ce)
    - [Колоды](#org5980edf)
    - [Рифмы](#orgb2013ea)
    - [Компартментализм](#org2957d61)
  - [События](#org01b6a6c)
  - [Словарь](#orgf486a73)
    - [Личный словарь терминов](#org6ecff73)
    - [Словарь иностранных слов](#org5da0397)
  - [Импорт данных из веб-сервисов](#orgc42fcda)
- [Поиск подхода к реализации](#org0c51fd7)
  - [Декомпозиция](#orgd5f6570)
    - [Блог](#org77b429e)
    - [Оценка количества триплетов при импорте книги](#org284e24d)
  - [Базовые определения](#orgff227c3)
    - [Ресурс](#orgf45bf7b)
    - [Представление](#orgfbd68e1)
    - [Атрибут](#orge35f806)
    - [Адаптер](#orgc67b1b1)
- [Как это все может выглядеть на практике](#orgf5d3bb5)
  - [Реляционный подход](#orgf83d60d)
    - [Конспект](#orgaaba482)
    - [Цитаты, разложенные по главам](#org48a0e6d)
  - [Обычный реляционный подход + наведенная семантика](#org953065b)
  - [Семантика](#org6c7bf66)
    - [OpenLink Virtuoso](#orge4e3757)
    - [Stardog](#org613a5d8)
    - [AllegroGraph](#orga6d9646)
  - [Графовая база данных](#orge906226)
- [История](#org558fbdf)
  - [(1945) Vannevar Bush — As We May Think](#org668d0c0)
  - [(1967) Andries van Dam, Ted Nelson — Hypertext Editing System](#org0cac54f)
  - [(1968) Douglas Engelbart — oN-Line System](#org0b5c8e8)
  - [(1968) Andries van Dam — File Retrieval and Editing System](#org8b7501b)
  - [(1985) Intermedia](#orge390906)
  - [(1991) Gifford — Semantic file systems](#org209c4bd)
  - [(1993) LDAP](#orga218499)
  - [(1996) Eric Freeman and David Gelertner — Lifestreams](#org3af833c)
  - [(1999) Presto](#org4de5230)
  - [(2000) id3v2.4](#orgbdcdda6)
  - [(2000) MusicBrainz](#org01b200d)
  - [(2001) Eric Kim — Purple](#org9232047)
  - [(2001) Tim Berners-Lee — Semantic Web](#orgc8b4c87)
  - [(2001) Tinderbox](#org221bdcf)
  - [(2003) Joshua Schachter — Del.icio.us](#org4eb9a41)
  - [(2003) Carsten Dominik — Org-mode](#orga63238d)
  - [2006 Calibre](#orga1b481a)
  - [(2004) W3C — RDF / RDFS / OWL](#org65b854e)
  - [(2007) DBpedia](#org47376f7)
  - [(2007) Scrivener](#org4f5ea7a)
  - [(2008) Evernote](#orgbaf30ff)
  - [(2009) Fluidinfo](#org1bc5f16)
  - [(2013) Ginko](#org41b6910)
  - [Smallest Federated Wiki](#org864ad4b)
  - [Chandler](#org3be4db1)
  - [CommonTag](#org346e066)
  - [Friendfeed](#org73194f2)
  - [Locker](#orgbe585e3)
  - [Singly](#orgdc71e73)
  - [NEPOMUK](#orgf8d652b)
  - [TiddlyWiki](#orgd1bc5ca)
- [Ссылки](#orgb29c701)
  - [Учебные заведения](#org118a777)
  - [Термины](#org7348c14)
  - [Люди](#org958a145)
  - [Книги](#orge74af1e)
  - [Ассоциации](#orge158d9d)
  - [urbansheep](#orgd33dedb)
    - [Pinboard](#org025c43a)
    - [FriendFeed](#org862beca)
    - [LiveJournal](#org3c0a78d)
  - [Конференции](#orga7cbd7f)

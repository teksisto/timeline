...
1.  [Предпосылки](#org3f4717d)
2.  [Задачи инфоорга](#orge17c942)
    1.  [Захват](#org26e9050)
    2.  [Идентификация](#orgeef93fd)
    3.  [Хранение](#orgde21736)
    4.  [Классификация](#org7dfc230)
    5.  [Структурирование](#org2844eef)
    6.  [Поиск](#org5048f8b)
    7.  [Репрезентация](#org08f2319)
    8.  [Аннотирование](#orgea12ccb)
    9.  [Переносимость](#org935008e)
3.  [Чего мне хочется от информационного менеджера](#orgf6088b3)
    1.  [Объединение базы данных и файлового менеджера](#org158b2de)
    2.  [Блочный текстовый редактор](#orge938499)
        1.  [Зачем бить на блочные элементы](#org1281835)
    3.  [Динамические деревья](#orgd14ed49)
        1.  [Проблемы иерархических файловых систем](#orgece1aca)
        2.  [Замена одного дерево на множество](#org05ef397)
        3.  [Сохранение файловой семантики](#org167ed69)
    4.  [Контекст](#org21132a2)
        1.  [Заголовочный блок](#org91d1375)
        2.  [Форма быстрого поста](#orge4a2c4c)
        3.  [Хвост](#org0eb7655)
        4.  [Контекст есть у каждого ресурса](#orgb160751)
        5.  [Контекст как строительный блок интерфейса](#orgd5efa7f)
        6.  [Динамическое дерево как вложенные контексты](#orgf073935)
    5.  [Параллельные тексты](#org55f205a)
4.  [Что бы я со всем этим делал](#orgad26078)
    1.  [Оглавления для источников](#orge387a00)
    2.  [Конспекты](#org376b606)
    3.  [Цитатник](#org8b7660c)
        1.  [Привязка цитат к оглавлению книги](#org9b4c152)
        2.  [Заголовки для цитат](#orgfdbc66c)
        3.  [Форматирование внутри цитат](#orgd4ef575)
        4.  [Параллельные цитатники](#orgd7c0e88)
        5.  [Колоды](#orgd638cbe)
        6.  [Рифмы](#orged7b732)
        7.  [Компартментализм](#org9e87622)
    4.  [События](#org9b78609)
    5.  [Словарь](#org4bf5019)
        1.  [Личный словарь терминов](#org77b40fb)
        2.  [Словарь иностранных слов](#org440529b)
    6.  [Импорт данных из веб-сервисов](#org14024f4)
5.  [Поиск подхода к реализации](#orgbf52034)
    1.  [Декомпозиция](#orgad9e68f)
        1.  [Блог](#orgf50694b)
        2.  [Оценка количества триплетов при импорте книги](#org306f526)
    2.  [Базовые определения](#org68a107b)
        1.  [Ресурс](#orgdddacd9)
        2.  [Представление](#org9373789)
        3.  [Атрибут](#org7512de5)
        4.  [Адаптер](#orgb27e44b)
6.  [Как это все может выглядеть на практике](#org3f8636e)
    1.  [Реляционный подход](#org8f13d7f)
        1.  [Конспект](#orgcff15e8)
        2.  [Цитаты, разложенные по главам](#orgf1a1a1c)
    2.  [Обычный реляционный подход + наведенная семантика](#org865a665)
    3.  [Семантика](#org8b54410)
        1.  [OpenLink Virtuoso](#org8795efe)
        2.  [Stardog](#org5016f91)
        3.  [AllegroGraph](#org8d7394e)
    4.  [Графовая база данных](#org1d65429)
7.  [История](#org2566859)
    1.  [(1945) Vannevar Bush — As We May Think](#orgfe06450)
    2.  [(1967) Andries van Dam, Ted Nelson — Hypertext Editing System](#org358f861)
    3.  [(1968) Douglas Engelbart — oN-Line System](#org028d268)
    4.  [(1968) Andries van Dam — File Retrieval and Editing System](#orgd135e79)
    5.  [(1985) Intermedia](#org3ce727f)
    6.  [(1991) Gifford — Semantic file systems](#org579700e)
    7.  [(1993) LDAP](#org8888c2c)
    8.  [(1996) Eric Freeman and David Gelertner — Lifestreams](#org56b179f)
    9.  [(1999) Presto](#orgd8d7669)
    10. [(2000) id3v2.4](#orgb42e59a)
    11. [(2000) MusicBrainz](#org7f6ac9f)
    12. [(2001) Eric Kim — Purple](#org57d13dc)
    13. [(2001) Tim Berners-Lee — Semantic Web](#orga1176fe)
    14. [(2001) Tinderbox](#org55ee724)
    15. [(2003) Joshua Schachter — Del.icio.us](#org5ef0d12)
    16. [(2003) Carsten Dominik — Org-mode](#orgf08733a)
    17. [2006 Calibre](#org72d167b)
    18. [(2004) W3C — RDF / RDFS / OWL](#org2721837)
    19. [(2007) DBpedia](#org0494d10)
    20. [(2007) Scrivener](#org79086d0)
    21. [(2008) Evernote](#org35bac79)
    22. [(2009) Fluidinfo](#org4cc7b82)
    23. [(2013) Ginko](#org819984f)
    24. [Smallest Federated Wiki](#org9d8f15c)
    25. [Chandler](#orge66aacd)
    26. [CommonTag](#org7ed6181)
    27. [Friendfeed](#org03f6849)
    28. [Locker](#org47c6b13)
    29. [Singly](#orgf28462b)
    30. [NEPOMUK](#org5c6f0dc)
    31. [TiddlyWiki](#org5b1d6d8)
8.  [Ссылки](#org9792a70)
    1.  [Учебные заведения](#orga0efaf8)
    2.  [Термины](#org1b22412)
    3.  [Люди](#orgae7c64f)
    4.  [Книги](#orga621dbd)
    5.  [Ассоциации](#org36813a4)
    6.  [urbansheep](#org6135ac8)
        1.  [Pinboard](#org007add6)
        2.  [FriendFeed](#orgc9e8c47)
        3.  [LiveJournal](#org4ce1daf)
    7.  [Конференции](#org52a7542)

...
<li><a href="#orgheadline44">3. Чего мне хочется от информационного менеджера</a>
<ul>
<li><a href="#orgheadline11">3.1. Оглавления для источников</a></li>
<li><a href="#orgheadline19">3.2. Цитатник</a>
<ul>
...
<li><a href="#orgheadline14">3.2.3. Форматирование внутри цитат</a></li>
<li><a href="#orgheadline15">3.2.4. Параллельные цитатники</a></li>
<li><a href="#orgheadline16">3.2.5. Колоды</a></li>
<li><a href="#orgheadline17">3.2.6. Рифмы</a></li>
<li><a href="#orgheadline18">3.2.7. Компартментализм</a></li>
</ul>
</li>
<li><a href="#orgheadline20">3.3. События</a></li>
<li><a href="#orgheadline23">3.4. Словарь</a>
<ul>
<li><a href="#orgheadline21">3.4.1. Личный словарь терминов</a></li>
<li><a href="#orgheadline22">3.4.2. Словарь иностранных слов</a></li>
</ul>
</li>
<li><a href="#orgheadline31">3.5. Контекст</a>
<ul>
<li><a href="#orgheadline24">3.5.1. Заголовочный блок</a></li>
<li><a href="#orgheadline25">3.5.2. Форма быстрого поста</a></li>
<li><a href="#orgheadline26">3.5.3. Хвост</a></li>
<li><a href="#orgheadline27">3.5.4. Контекст есть у каждого ресурса</a></li>
<li><a href="#orgheadline28">3.5.5. Контекст как строительный блок интерфейса</a></li>
<li><a href="#orgheadline29">3.5.6. Динамическое дерево как вложенные контексты</a></li>
<li><a href="#orgheadline30">3.5.7. Вопросы</a></li>
</ul>
</li>
<li><a href="#orgheadline32">3.6. Параллельные тексты</a></li>
<li><a href="#orgheadline35">3.7. Блочный текстовый редактор</a>
<ul>
<li><a href="#orgheadline33">3.7.1. Зачем бить на блочные элементы</a></li>
<li><a href="#orgheadline34">3.7.2. Post with input/output</a></li>
</ul>
</li>
<li><a href="#orgheadline36">3.8. Импорт данных из веб-сервисов</a></li>
<li><a href="#orgheadline43">3.9. Динамические деревья</a>
<ul>
<li><a href="#orgheadline37">3.9.1. Проблемы иерархических файловых систем</a></li>
<li><a href="#orgheadline38">3.9.2. Замена одного дерево на множество</a></li>
<li><a href="#orgheadline42">3.9.3. Сохранение файловой семантики</a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#orgheadline53">4. Поиск подхода к реализации</a>
<ul>
<li><a href="#orgheadline47">4.1. Декомпозиция</a>
<ul>
<li><a href="#orgheadline45">4.1.1. Блог</a></li>
<li><a href="#orgheadline46">4.1.2. Оценка количества триплетов при импорте книги</a></li>
</ul>
</li>
<li><a href="#orgheadline52">4.2. Базовые определения</a>
<ul>
<li><a href="#orgheadline48">4.2.1. Ресурс</a></li>
<li><a href="#orgheadline49">4.2.2. Представление</a></li>
<li><a href="#orgheadline50">4.2.3. Атрибут</a></li>
<li><a href="#orgheadline51">4.2.4. Адаптер</a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#orgheadline62">5. Как это все может выглядеть на практике</a>
<ul>
<li><a href="#orgheadline56">5.1. Реляционный подход</a>
<ul>
<li><a href="#orgheadline54">5.1.1. Конспект</a></li>
<li><a href="#orgheadline55">5.1.2. Цитаты, разложенные по главам</a></li>
</ul>
</li>
<li><a href="#orgheadline57">5.2. Обычный реляционный подход + наведенная семантика</a></li>
<li><a href="#orgheadline60">5.3. Семантика</a>
<ul>
<li><a href="#orgheadline58">5.3.1. OpenLink Virtuoso</a></li>
<li><a href="#orgheadline59">5.3.2. AllegroGraph</a></li>
</ul>
</li>
<li><a href="#orgheadline61">5.4. Графовая база данных</a></li>
</ul>
</li>
<li><a href="#orgheadline89">6. История</a>
<ul>
<li><a href="#orgheadline63">6.1. Vannevar Bush — As We May Think (1945)</a></li>
<li><a href="#orgheadline64">6.2. Douglas Engelbart — The Mother of All Demos (1968)</a></li>
<li><a href="#orgheadline65">6.3. Gifford — Semantic file systems (1991)</a></li>
<li><a href="#orgheadline66">6.4. LDAP (1993)</a></li>
<li><a href="#orgheadline67">6.5. id3v2.4 (2000)</a></li>
<li><a href="#orgheadline68">6.6. MusicBrainz (2000)</a></li>
<li><a href="#orgheadline69">6.7. Eric Kim — Purple (2001)</a></li>
<li><a href="#orgheadline70">6.8. Joshua Schachter — Del.icio.us (2003)</a></li>
<li><a href="#orgheadline71">6.9. W3C — RDF / RDFS / OWL (2004)</a></li>
<li><a href="#orgheadline72">6.10. DBpedia (2007)</a></li>
<li><a href="#orgheadline73">6.11. Scrivener (2007)</a></li>
<li><a href="#orgheadline74">6.12. Evernote (2008)</a></li>
<li><a href="#orgheadline75">6.13. Fluidinfo (2009)</a></li>
<li><a href="#orgheadline76">6.14. Ginko (2013)</a></li>
<li><a href="#orgheadline77">6.15. Org-mode</a></li>
<li><a href="#orgheadline78">6.16. Calibre</a></li>
<li><a href="#orgheadline79">6.17. Smallest Federated Wiki</a></li>
<li><a href="#orgheadline80">6.18. Chandler</a></li>
<li><a href="#orgheadline81">6.19. CommonTag (dead)</a></li>
<li><a href="#orgheadline82">6.20. Friendfeed (dead)</a></li>
<li><a href="#orgheadline83">6.21. Locker (dead)</a></li>
<li><a href="#orgheadline84">6.22. Singly (dead)</a></li>
<li><a href="#orgheadline85">6.23. vk.com/audio</a></li>
<li><a href="#orgheadline86">6.24. NEPOMUK (framework)</a></li>
<li><a href="#orgheadline87">6.25. TiddlyWiki</a></li>
<li><a href="#orgheadline88">6.26. Tinderbox</a></li>
</ul>
</li>
<li><a href="#orgheadline102">7. Ссылки</a>
<ul>
<li><a href="#orgheadline90">7.1. Учебные заведения</a></li>
<li><a href="#orgheadline91">7.2. Термины</a></li>
<li><a href="#orgheadline92">7.3. Люди</a></li>
<li><a href="#orgheadline93">7.4. Книги</a></li>
<li><a href="#orgheadline95">7.5. Ассоциации</a>
<ul>
<li><a href="#orgheadline94">7.5.1. Association for Information Science and Technology</a></li>
</ul>
</li>
<li><a href="#orgheadline99">7.6. urbansheep</a>
<ul>
<li><a href="#orgheadline96">7.6.1. LiveJournal</a></li>
<li><a href="#orgheadline97">7.6.2. FriendFeed</a></li>
<li><a href="#orgheadline98">7.6.3. Pinboard</a></li>
</ul>
</li>
<li><a href="#orgheadline101">7.7. Конференции</a>
<ul>
<li><a href="#orgheadline100">7.7.1. Personal Digital Archiving Conference</a></li>
</ul>
</li>
</ul>
</li>
...
# Чего мне хочется от информационного менеджера<a id="orgheadline44"></a>
...
### Форматирование внутри цитат<a id="orgheadline14"></a>
...
### Параллельные цитатники<a id="orgheadline15"></a>
...
### Компартментализм<a id="orgheadline18"></a>
...
## Словарь<a id="orgheadline23"></a>

### Личный словарь терминов<a id="orgheadline21"></a>

Карточки для терминов, встреченных в тексте. Крепятся к
оглавлению. Автоматически генерируют ссылки на запрос в гугл и
википедию.

### Словарь иностранных слов<a id="orgheadline22"></a>
...
### Заголовочный блок<a id="orgheadline24"></a>
...
### Форма быстрого поста<a id="orgheadline25"></a>
...
### Контекст есть у каждого ресурса<a id="orgheadline27"></a>
...
### Контекст как строительный блок интерфейса<a id="orgheadline28"></a>
...
### Динамическое дерево как вложенные контексты<a id="orgheadline29"></a>
...
## Параллельные тексты<a id="orgheadline32"></a>
...
### Зачем бить на блочные элементы<a id="orgheadline33"></a>
...
### Post with input/output<a id="orgheadline34"></a>
...
## Динамические деревья<a id="orgheadline43"></a>

### Проблемы иерархических файловых систем<a id="orgheadline37"></a>
...
### Замена одного дерево на множество<a id="orgheadline38"></a>
...
### Сохранение файловой семантики<a id="orgheadline42"></a>
...
# Поиск подхода к реализации<a id="orgheadline53"></a>

Самое вменяемое решение, которое я вижу &#x2013; это [RDF](https://en.wikipedia.org/wiki/Resource_Description_Framework). 

## Декомпозиция<a id="orgheadline47"></a>

### Блог<a id="orgheadline45"></a>
...
### Оценка количества триплетов при импорте книги<a id="orgheadline46"></a>
...
## Базовые определения<a id="orgheadline52"></a>

### Ресурс<a id="orgheadline48"></a>
...
### Представление<a id="orgheadline49"></a>
...
# Как это все может выглядеть на практике<a id="orgheadline62"></a>

RDF &#x2013; это идея, что данные хранятся в графе. Хранить этот граф и
управлять им можно по-разному.

## Реляционный подход<a id="orgheadline56"></a>
...
### Цитаты, разложенные по главам<a id="orgheadline55"></a>
...
## Обычный реляционный подход + наведенная семантика<a id="orgheadline57"></a>
...
## Семантика<a id="orgheadline60"></a>
...
### OpenLink Virtuoso<a id="orgheadline58"></a>

<http://virtuoso.openlinksw.com/>

### AllegroGraph<a id="orgheadline59"></a>
...
## Графовая база данных<a id="orgheadline61"></a>
...
## Douglas Engelbart — The Mother of All Demos (1968)<a id="orgheadline64"></a>
...
## Gifford — Semantic file systems (1991)<a id="orgheadline65"></a>
...
## MusicBrainz (2000)<a id="orgheadline68"></a>
...
## Eric Kim — Purple (2001)<a id="orgheadline69"></a>
...
## Joshua Schachter — Del.icio.us (2003)<a id="orgheadline70"></a>
...
## W3C — RDF / RDFS / OWL (2004)<a id="orgheadline71"></a>

## DBpedia (2007)<a id="orgheadline72"></a>
...
## Scrivener (2007)<a id="orgheadline73"></a>
...
## Smallest Federated Wiki<a id="orgheadline79"></a>
...
## Chandler<a id="orgheadline80"></a>

<https://en.wikipedia.org/wiki/Chandler_%28software%29>

## CommonTag (dead)<a id="orgheadline81"></a>
...
## vk.com/audio<a id="orgheadline85"></a>
...
## NEPOMUK (framework)<a id="orgheadline86"></a>

<https://en.wikipedia.org/wiki/NEPOMUK_%28framework%29>

## TiddlyWiki<a id="orgheadline87"></a>

<http://tiddlywiki.com/>

## Tinderbox<a id="orgheadline88"></a>
...
## Учебные заведения<a id="orgheadline90"></a>
...
## Ассоциации<a id="orgheadline95"></a>

### Association for Information Science and Technology<a id="orgheadline94"></a>

Ааа, ыыы, много всего, оно живое. 

<https://www.asist.org/>

## urbansheep<a id="orgheadline99"></a>

### LiveJournal<a id="orgheadline96"></a>
...
### FriendFeed<a id="orgheadline97"></a>
...
## Конференции<a id="orgheadline101"></a>

### Personal Digital Archiving Conference<a id="orgheadline100"></a>

...
<li><a href="#orgheadline41">3. Чего мне хочется от информационного менеджера</a>
<ul>
...
<li><a href="#orgheadline25">3.5.3. Запрос</a></li>
<li><a href="#orgheadline26">3.5.4. Хвост</a></li>
<li><a href="#orgheadline27">3.5.5. Контекст есть у каждого ресурса</a></li>
<li><a href="#orgheadline28">3.5.6. Контекст как строительный блок интерфейса</a></li>
<li><a href="#orgheadline29">3.5.7. Динамическое дерево как вложенные контексты</a></li>
<li><a href="#orgheadline30">3.5.8. Вопросы</a></li>
</ul>
</li>
...
<li><a href="#orgheadline40">3.9. Динамические деревья</a>
<ul>
...
<li><a href="#orgheadline39">3.9.3. Сохранение файловой семантики</a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#orgheadline50">4. Поиск подхода к реализации</a>
<ul>
<li><a href="#orgheadline44">4.1. Декомпозиция</a>
<ul>
<li><a href="#orgheadline42">4.1.1. Блог</a></li>
<li><a href="#orgheadline43">4.1.2. Оценка количества триплетов при импорте книги</a></li>
</ul>
</li>
<li><a href="#orgheadline49">4.2. Базовые определения</a>
<ul>
<li><a href="#orgheadline45">4.2.1. Ресурс</a></li>
<li><a href="#orgheadline46">4.2.2. Представление</a></li>
<li><a href="#orgheadline47">4.2.3. Атрибут</a></li>
<li><a href="#orgheadline48">4.2.4. Адаптер</a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#orgheadline59">5. Как это все может выглядеть на практике</a>
<ul>
<li><a href="#orgheadline53">5.1. Реляционный подход</a>
<ul>
<li><a href="#orgheadline51">5.1.1. Конспект</a></li>
<li><a href="#orgheadline52">5.1.2. Цитаты, разложенные по главам</a></li>
</ul>
</li>
<li><a href="#orgheadline54">5.2. Обычный реляционный подход + наведенная семантика</a></li>
<li><a href="#orgheadline57">5.3. Семантика</a>
<ul>
<li><a href="#orgheadline55">5.3.1. OpenLink Virtuoso</a></li>
<li><a href="#orgheadline56">5.3.2. AllegroGraph</a></li>
</ul>
</li>
<li><a href="#orgheadline58">5.4. Графовая база данных</a></li>
</ul>
</li>
<li><a href="#orgheadline79">6. Case study</a>
<ul>
<li><a href="#orgheadline60">6.1. Purple</a></li>
<li><a href="#orgheadline61">6.2. Gifford - Semantic file systems</a></li>
<li><a href="#orgheadline62">6.3. MusicBrainz</a></li>
<li><a href="#orgheadline63">6.4. Org-mode</a></li>
<li><a href="#orgheadline64">6.5. Fluidinfo</a></li>
<li><a href="#orgheadline65">6.6. Calibre</a></li>
<li><a href="#orgheadline66">6.7. Ginko</a></li>
<li><a href="#orgheadline67">6.8. Smallest Federated Wiki</a></li>
<li><a href="#orgheadline68">6.9. Del.icio.us</a></li>
<li><a href="#orgheadline69">6.10. Chandler</a></li>
<li><a href="#orgheadline70">6.11. CommonTag (dead)</a></li>
<li><a href="#orgheadline71">6.12. Friendfeed (dead)</a></li>
<li><a href="#orgheadline72">6.13. Locker (dead)</a></li>
<li><a href="#orgheadline73">6.14. Singly (dead)</a></li>
<li><a href="#orgheadline74">6.15. vk.com/audio</a></li>
<li><a href="#orgheadline75">6.16. NEPOMUK (framework)</a></li>
<li><a href="#orgheadline76">6.17. TiddlyWiki</a></li>
<li><a href="#orgheadline77">6.18. Scrivener</a></li>
<li><a href="#orgheadline78">6.19. Tinderbox</a></li>
</ul>
</li>
<li><a href="#orgheadline90">7. Ссылки</a>
<ul>
<li><a href="#orgheadline80">7.1. Учебные заведения</a></li>
<li><a href="#orgheadline81">7.2. Термины</a></li>
<li><a href="#orgheadline82">7.3. Книги</a></li>
<li><a href="#orgheadline84">7.4. Ассоциации</a>
<ul>
<li><a href="#orgheadline83">7.4.1. Association for Information Science and Technology</a></li>
</ul>
</li>
<li><a href="#orgheadline87">7.5. urbansheep</a>
<ul>
<li><a href="#orgheadline85">7.5.1. LiveJournal</a></li>
<li><a href="#orgheadline86">7.5.2. FriendFeed</a></li>
</ul>
</li>
<li><a href="#orgheadline89">7.6. Конференции</a>
<ul>
<li><a href="#orgheadline88">7.6.1. Personal Digital Archiving Conference</a></li>
</ul>
</li>
</ul>
</li>
...
# Чего мне хочется от информационного менеджера<a id="orgheadline41"></a>
...
## Динамические деревья<a id="orgheadline40"></a>
...
### Сохранение файловой семантики<a id="orgheadline39"></a>
...
использовать WebDAW, монтировать веб-приложение как папку и снова
пользоваться ей как файловой системой.

# Поиск подхода к реализации<a id="orgheadline50"></a>

Самое вменяемое решение, которое я вижу &#x2013; это rdf. 

## Декомпозиция<a id="orgheadline44"></a>

### Блог<a id="orgheadline42"></a>
...
### Оценка количества триплетов при импорте книги<a id="orgheadline43"></a>
...
## Базовые определения<a id="orgheadline49"></a>

### Ресурс<a id="orgheadline45"></a>
...
### Представление<a id="orgheadline46"></a>
...
# Как это все может выглядеть на практике<a id="orgheadline59"></a>
...
### Цитаты, разложенные по главам<a id="orgheadline52"></a>
...
## Обычный реляционный подход + наведенная семантика<a id="orgheadline54"></a>
...
## Семантика<a id="orgheadline57"></a>
...
### OpenLink Virtuoso<a id="orgheadline55"></a>

<http://virtuoso.openlinksw.com/>

### AllegroGraph<a id="orgheadline56"></a>
...
## Графовая база данных<a id="orgheadline58"></a>
...
# Case study<a id="orgheadline79"></a>

## Purple<a id="orgheadline60"></a>
...
## Gifford - Semantic file systems<a id="orgheadline61"></a>
...
## MusicBrainz<a id="orgheadline62"></a>

Онтология для музыки.

<https://musicbrainz.org/>

## Org-mode<a id="orgheadline63"></a>

<http://orgmode.org/>

## Fluidinfo<a id="orgheadline64"></a>

У них очень прикольный [блог](http://blogs.fluidinfo.com/), если читать его с начала, а не с конца.

<http://fluidinfo.com>

## Calibre<a id="orgheadline65"></a>
...
## Chandler<a id="orgheadline69"></a>

<https://en.wikipedia.org/wiki/Chandler_%28software%29>

## CommonTag (dead)<a id="orgheadline70"></a>
...
## vk.com/audio<a id="orgheadline74"></a>
...
## Ассоциации<a id="orgheadline84"></a>

### Association for Information Science and Technology<a id="orgheadline83"></a>

Ааа, ыыы, много всего, оно живое. 

<https://www.asist.org/>

## urbansheep<a id="orgheadline87"></a>

### LiveJournal<a id="orgheadline85"></a>
...
### FriendFeed<a id="orgheadline86"></a>
...
## Конференции<a id="orgheadline89"></a>

### Personal Digital Archiving Conference<a id="orgheadline88"></a>

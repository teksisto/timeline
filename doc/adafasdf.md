- [Предпосылки](#org1c6890d)
- [Задачи инфоорга](#org9e5fe10)
  - [Захват](#org459501f)
  - [Идентификация](#orge842e17)
  - [Хранение](#org5b6ab28)
  - [Классификация](#org1d672ea)
  - [Структурирование](#org214dfdc)
  - [Поиск](#org809cfe3)
  - [Репрезентация](#orgfb00d29)
  - [Аннотирование](#orge03779d)
  - [Переносимость](#org4354241)
- [Чего мне хочется от информационного менеджера](#orgb4f4374)
  - [Блочный текстовый редактор](#orgef3b0c9)
    - [Зачем бить на блочные элементы](#org95fac2a)
    - [Post with input/output](#orgea62eca)
  - [Динамические деревья](#orgaeb5f8e)
    - [Проблемы иерархических файловых систем](#orgabee7e8)
    - [Замена одного дерево на множество](#orgbc247f0)
    - [Сохранение файловой семантики](#org3ab29bb)
  - [Контекст](#org378b6d5)
    - [Заголовочный блок](#org4ebcdb6)
    - [Форма быстрого поста](#orge5e374c)
    - [Хвост](#org8b44a91)
    - [Контекст есть у каждого ресурса](#org9dd3abc)
    - [Контекст как строительный блок интерфейса](#orgca2b000)
    - [Динамическое дерево как вложенные контексты](#orga9f47f6)
    - [Вопросы](#orgdf8f92b)
  - [Оглавления для источников](#org02c8bbb)
  - [Цитатник](#org5093d32)
    - [Привязка цитат к оглавлению книги](#org541da4a)
    - [Заголовки для цитат](#org1ab8f7a)
    - [Форматирование внутри цитат](#org1941293)
    - [Параллельные цитатники](#orge4ec8b5)
    - [Колоды](#org5424f66)
    - [Рифмы](#org72b4298)
    - [Компартментализм](#orga04a8d7)
  - [События](#orgbd318d9)
  - [Словарь](#orgf9d19ba)
    - [Личный словарь терминов](#org07cb993)
    - [Словарь иностранных слов](#orga68c193)
  - [Параллельные тексты](#orgb3f1a08)
  - [Импорт данных из веб-сервисов](#org1730004)
  - [Конспекты](#orgd7ad771)
- [Поиск подхода к реализации](#org3425145)
  - [Декомпозиция](#org976ab68)
    - [Блог](#org2723438)
    - [Оценка количества триплетов при импорте книги](#orgdaad1b7)
  - [Базовые определения](#orgfb37ba7)
    - [Ресурс](#orgabdd688)
    - [Представление](#org69f6604)
    - [Атрибут](#orgcd803b2)
    - [Адаптер](#orgf7c8075)
- [Как это все может выглядеть на практике](#org6f4e7a5)
  - [Реляционный подход](#org106b18b)
    - [Конспект](#orgda6fd86)
    - [Цитаты, разложенные по главам](#org268b480)
  - [Обычный реляционный подход + наведенная семантика](#org0d8313c)
  - [Семантика](#org36cb10c)
    - [OpenLink Virtuoso](#org68ad24e)
    - [AllegroGraph](#org3cf2864)
  - [Графовая база данных](#orgdff6600)
- [История](#org376e512)
  - [(1945) Vannevar Bush — As We May Think](#org6a447da)
  - [(1967) Andries van Dam, Ted Nelson — Hypertext Editing System](#org65062b8)
  - [(1968) Douglas Engelbart — oN-Line System](#orga5b5de7)
  - [(1968) Andries van Dam — File Retrieval and Editing System](#org6f388a4)
  - [(1985) Intermedia](#org04bb78a)
  - [(1991) Gifford — Semantic file systems](#org665f21e)
  - [(1993) LDAP](#org11dfe13)
  - [(1996) Eric Freeman and David Gelertner — Lifestreams](#org53cbda3)
  - [(1999) Presto](#org1852ac8)
  - [(2000) id3v2.4](#orgfb3c919)
  - [(2000) MusicBrainz](#orgc5cb590)
  - [(2001) Eric Kim — Purple](#orgdbacee7)
  - [(2001) Tim Berners-Lee — Semantic Web](#org5eaf5f1)
  - [(2001) Tinderbox](#org4b83832)
  - [(2003) Joshua Schachter — Del.icio.us](#org7a970e7)
  - [(2003) Org-mode](#org444c81a)
  - [(2004) W3C — RDF / RDFS / OWL](#orge457984)
  - [(2007) DBpedia](#org4296756)
  - [(2007) Scrivener](#org49c0ba8)
  - [(2008) Evernote](#org5de3e27)
  - [(2009) Fluidinfo](#orgdb16632)
  - [(2013) Ginko](#orgec52158)
  - [Calibre](#org66a3bfc)
  - [Smallest Federated Wiki](#orgd405256)
  - [Chandler](#orge00f812)
  - [CommonTag](#org56c97d0)
  - [Friendfeed](#org1a6d7fb)
  - [Locker](#org7f65937)
  - [Singly](#orga4c80ab)
  - [NEPOMUK](#orgc80a609)
  - [TiddlyWiki](#orgc96b6f4)
- [Ссылки](#orgae751ed)
  - [Учебные заведения](#orgdf8dde5)
  - [Термины](#org72f1aa9)
  - [Люди](#orgbbe3f0d)
  - [Книги](#org6ef7cdf)
  - [Ассоциации](#org0811497)
    - [Association for Information Science and Technology](#org886a436)
  - [urbansheep](#org1a7da54)
    - [LiveJournal](#orgabd29c9)
    - [FriendFeed](#org2db0bd2)
    - [Pinboard](#org0976231)
  - [Конференции](#orgdd512b7)
    - [Personal Digital Archiving Conference](#org5882395)

...
<li><a href="#orgheadline43">3. Чего мне хочется от информационного менеджера</a>
<ul>
...
<li><a href="#orgheadline42">3.9. Динамические деревья</a>
<ul>
...
<li><a href="#orgheadline41">3.9.3. Сохранение файловой семантики</a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#orgheadline52">4. Поиск подхода к реализации</a>
<ul>
<li><a href="#orgheadline46">4.1. Декомпозиция</a>
<ul>
<li><a href="#orgheadline44">4.1.1. Блог</a></li>
<li><a href="#orgheadline45">4.1.2. Оценка количества триплетов при импорте книги</a></li>
</ul>
</li>
<li><a href="#orgheadline51">4.2. Базовые определения</a>
<ul>
<li><a href="#orgheadline47">4.2.1. Ресурс</a></li>
<li><a href="#orgheadline48">4.2.2. Представление</a></li>
<li><a href="#orgheadline49">4.2.3. Атрибут</a></li>
<li><a href="#orgheadline50">4.2.4. Адаптер</a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#orgheadline61">5. Как это все может выглядеть на практике</a>
<ul>
<li><a href="#orgheadline55">5.1. Реляционный подход</a>
<ul>
<li><a href="#orgheadline53">5.1.1. Конспект</a></li>
<li><a href="#orgheadline54">5.1.2. Цитаты, разложенные по главам</a></li>
</ul>
</li>
<li><a href="#orgheadline56">5.2. Обычный реляционный подход + наведенная семантика</a></li>
<li><a href="#orgheadline59">5.3. Семантика</a>
<ul>
<li><a href="#orgheadline57">5.3.1. OpenLink Virtuoso</a></li>
<li><a href="#orgheadline58">5.3.2. AllegroGraph</a></li>
</ul>
</li>
...
# Чего мне хочется от информационного менеджера<a id="orgheadline43"></a>
...
## Динамические деревья<a id="orgheadline42"></a>
...
### Сохранение файловой семантики<a id="orgheadline41"></a>
...
# Поиск подхода к реализации<a id="orgheadline52"></a>

Самое вменяемое решение, которое я вижу &#x2013; это [RDF](https://en.wikipedia.org/wiki/Resource_Description_Framework). 

## Декомпозиция<a id="orgheadline46"></a>

### Блог<a id="orgheadline44"></a>
...
### Оценка количества триплетов при импорте книги<a id="orgheadline45"></a>
...
## Базовые определения<a id="orgheadline51"></a>

### Ресурс<a id="orgheadline47"></a>
...
### Представление<a id="orgheadline48"></a>
...
# Как это все может выглядеть на практике<a id="orgheadline61"></a>

RDF &#x2013; это идея, что данные хранятся в графе. Хранить этот граф и
управлять им можно по-разному.

## Реляционный подход<a id="orgheadline55"></a>
...
### Цитаты, разложенные по главам<a id="orgheadline54"></a>
...
## Обычный реляционный подход + наведенная семантика<a id="orgheadline56"></a>
...
## Семантика<a id="orgheadline59"></a>
...
### OpenLink Virtuoso<a id="orgheadline57"></a>

<http://virtuoso.openlinksw.com/>

### AllegroGraph<a id="orgheadline58"></a>
...
## Графовая база данных<a id="orgheadline60"></a>
...
## Douglas Engelbart — The Mother of All Demos (1968)<a id="orgheadline63"></a>
...
## Gifford — Semantic file systems (1991)<a id="orgheadline64"></a>

- [Предпосылки](#org44b14cf)
- [Задачи инфоорга](#org5c042d4)
  - [Захват](#org8f7db39)
  - [Идентификация](#org8f99d93)
  - [Хранение](#org1364704)
  - [Классификация](#orgff71109)
  - [Структурирование](#org5aab4b3)
  - [Поиск](#org69323ca)
  - [Репрезентация](#orga327700)
  - [Аннотирование](#org0d227cb)
  - [Переносимость](#orgd27ff89)
- [Чего мне хочется от информационного менеджера](#org8c2ff25)
  - [Объединение базы данных и файлового менеджера](#org3394396)
  - [Блочный текстовый редактор](#org6d417cb)
    - [Зачем бить на блочные элементы](#org9f3d1d2)
    - [Post with input/output](#orgbbdf4cc)
  - [Динамические деревья](#orgf1f9a4f)
    - [Проблемы иерархических файловых систем](#org12053f7)
    - [Замена одного дерево на множество](#orgf1a1b5f)
    - [Сохранение файловой семантики](#orgcfdec63)
  - [Контекст](#org8089669)
    - [Заголовочный блок](#orga43c5ee)
    - [Форма быстрого поста](#org672c5a6)
    - [Хвост](#org3383da0)
    - [Контекст есть у каждого ресурса](#org58856bf)
    - [Контекст как строительный блок интерфейса](#org8618d79)
    - [Динамическое дерево как вложенные контексты](#orgaeb3074)
    - [Вопросы](#org73940f0)
  - [Импорт данных из веб-сервисов](#org2e979be)
  - [Оглавления для источников](#org1c7ea39)
  - [Цитатник](#org304fea5)
    - [Привязка цитат к оглавлению книги](#orgd26053f)
    - [Заголовки для цитат](#org1f52d6a)
    - [Форматирование внутри цитат](#org2f82fd1)
    - [Параллельные цитатники](#orgcb8cf6d)
    - [Колоды](#org21841ee)
    - [Рифмы](#org83aa394)
    - [Компартментализм](#orgbcdac38)
  - [События](#orgf4cfa00)
  - [Словарь](#org2201f2b)
    - [Личный словарь терминов](#orgf2ac018)
    - [Словарь иностранных слов](#orgbe71a45)
  - [Параллельные тексты](#org3ece3c5)
  - [Конспекты](#org74a3610)
- [Поиск подхода к реализации](#org7e78022)
  - [Декомпозиция](#orge1ea9ab)
    - [Блог](#orga09e5e6)
    - [Оценка количества триплетов при импорте книги](#org3ac741b)
  - [Базовые определения](#org4ad25ee)
    - [Ресурс](#org4747b73)
    - [Представление](#orge0027d6)
    - [Атрибут](#orgaeed457)
    - [Адаптер](#org205b567)
- [Как это все может выглядеть на практике](#orgbaebb95)
  - [Реляционный подход](#org8043006)
    - [Конспект](#orgf8c1934)
    - [Цитаты, разложенные по главам](#orga055cbe)
  - [Обычный реляционный подход + наведенная семантика](#org03f3499)
  - [Семантика](#orgbdbea90)
    - [OpenLink Virtuoso](#orga44f473)
    - [AllegroGraph](#orgd27fd51)
  - [Графовая база данных](#org466f671)
- [История](#org193f1a7)
  - [(1945) Vannevar Bush — As We May Think](#orgd862d74)
  - [(1967) Andries van Dam, Ted Nelson — Hypertext Editing System](#org408668d)
  - [(1968) Douglas Engelbart — oN-Line System](#org725250f)
  - [(1968) Andries van Dam — File Retrieval and Editing System](#org7717dee)
  - [(1985) Intermedia](#org1e1d61a)
  - [(1991) Gifford — Semantic file systems](#org2e170e6)
  - [(1993) LDAP](#org64dcc16)
  - [(1996) Eric Freeman and David Gelertner — Lifestreams](#org9c11a47)
  - [(1999) Presto](#org7fe58d4)
  - [(2000) id3v2.4](#orgc11c63d)
  - [(2000) MusicBrainz](#orgee35411)
  - [(2001) Eric Kim — Purple](#org9276e11)
  - [(2001) Tim Berners-Lee — Semantic Web](#org8b6cfd0)
  - [(2001) Tinderbox](#orge3d5dd7)
  - [(2003) Joshua Schachter — Del.icio.us](#orgd50cf2b)
  - [(2003) Org-mode](#org5656e6a)
  - [(2004) W3C — RDF / RDFS / OWL](#org9665977)
  - [(2007) DBpedia](#orge45fd15)
  - [(2007) Scrivener](#org769a735)
  - [(2008) Evernote](#org97b20c2)
  - [(2009) Fluidinfo](#org8003fa2)
  - [(2013) Ginko](#org88d8b0b)
  - [Calibre](#org2dad8fa)
  - [Smallest Federated Wiki](#org2a97643)
  - [Chandler](#org038ef82)
  - [CommonTag](#orgb135df8)
  - [Friendfeed](#org478c218)
  - [Locker](#org127c050)
  - [Singly](#orge6f823d)
  - [NEPOMUK](#orgf7e291e)
  - [TiddlyWiki](#org3f3c016)
- [Ссылки](#orgfdca982)
  - [Учебные заведения](#org491c024)
  - [Термины](#org7e457e5)
  - [Люди](#orga497e6c)
  - [Книги](#org1603454)
  - [Ассоциации](#org836ed6c)
    - [Association for Information Science and Technology](#org7f36684)
  - [urbansheep](#orge2d6cf5)
    - [LiveJournal](#org83af082)
    - [FriendFeed](#orga3a0d3c)
    - [Pinboard](#org94dc7d1)
  - [Конференции](#orga728c36)
    - [Personal Digital Archiving Conference](#orgd2ad856)
